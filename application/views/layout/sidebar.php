...
<aside class="main-sidebar elevation-4 text-sm  sidebar-dark-yellow">
  <!-- Brand Logo -->
  <a href="<?=base_url()?>" class="brand-link navbar-yellow sidebar-dark-yellow text-sm">
    <img src="<?=base_url()?>assets/img/AdminLTELogo.png" alt="<?=base_name()?>"
      class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-dark" style="color: #000;"><?=base_name()?></span>
  </a>
